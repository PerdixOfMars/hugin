...
{
    auto screen =
        screen_with(munin::make_button(" OK ") | munin::with_id("ok_button"));
...
TEST_F(
    hugin_dsl_session,
    strict_find_reports_missing_automation_id_with_visible_nodes)
{
    auto screen = screen_with_single_button();
...
TEST_F(
    hugin_dsl_session,
    strict_find_returns_a_child_button_matching_automation_id)
{
    auto content = std::make_shared<munin::container>();
